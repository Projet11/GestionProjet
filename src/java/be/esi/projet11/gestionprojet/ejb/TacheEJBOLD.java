 ...
 * @author g34840
 */
@ManagedBean(name = "tacheEJBOLD")
@SessionScoped
public class TacheEJBOLD {
...
* @return the value of membreBean
    ...
    public TacheEJBOLD() throws TacheException, NotSupportedException, SystemException, RollbackException, HeuristicMixedException, HeuristicRollbackException, HeuristicRollbackException {
        System.out.println("---------MarqueTacheBean");
       this.creerTache("abc","abcdef", ImportanceEnum.TRESIMPORTANT);
...
* @param tache new value of tache
    ...
    public Tache creerTache(String nom, String description) throws TacheException {
        try {
            ...
            Logger.getLogger(TacheEJBOLD.class.getName()).log(Level.SEVERE, null, ex);
